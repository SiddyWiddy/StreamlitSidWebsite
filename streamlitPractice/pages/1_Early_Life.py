...
with sd.expander('Short Video'):
    sd.video('invideo-ai-1080 Meet Sid_ The Multifaceted Cartoon Chara 2024-07-25.mp4')
    sd.snow()
sd.snow()
with sd.expander('My personal photos'):

    sd.image('Screenshot 2024-07-23 at 22.54.09.png')
    sd.image('IMG_4891.jpeg')
    sd.image('IMG_4751.jpeg')
    sd.image('IMG_4868.jpeg')
    sd.snow()
sd.snow()
